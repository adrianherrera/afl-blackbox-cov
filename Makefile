...
PROGS       = afl-gcc afl-fuzz afl-showmap afl-tmin afl-gotcpu afl-analyze afl-blackbox-cov
...
afl-blackbox-cov: afl-fuzz.c $(COMM_HDR) | test_x86
	$(CC) $(CFLAGS) -DBLACKBOX_COV $< -o $@ $(LDFLAGS)
